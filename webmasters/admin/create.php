    ...
    if (empty($error)) {
        ...
        if ($existingUser) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $error = 'Gagal membuat akun Admin. Silakan coba lagi.';
                mysqli_stmt_close($stmt);
            }
        }
    }
...
<head>
    ...
    <title>Tambah Admin - Ngabar Yuk! Webmaster</title>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-stone-500 mt-2 leading-relaxed">
                            Buat akun baru untuk administrator yang akan membantu mengelola konten Ngabar Yuk!
                        </p>
                ...
                <form method="POST"
                    ...
                    <div class="p-6 md:p-7 space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-stone-400 mt-1.5">
                                Minimal 4 karakter. Huruf, angka, titik, garis bawah, dan tanda hubung.
                            </p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <i class="fa-solid fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-xs text-stone-400 pointer-events-none"></i>
                                        ...
                                        <input
                                            ...
                                            required
                                            class="form-field w-full pl-10 pr-11 py-3 bg-stone-50 border border-stone-200 rounded-xl text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:border-amber-600 focus:ring-4 focus:ring-amber-600/10">

                                        <button
                                            type="button"
                                            onclick="togglePassword('password', 'passwordIcon')"
                                            class="absolute right-0 top-0 h-full px-4 text-stone-400 hover:text-stone-700 transition">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <i class="fa-solid fa-shield-halved absolute left-4 top-1/2 -translate-y-1/2 text-xs text-stone-400 pointer-events-none"></i>
                                        ...
                                        <button
                                            type="button"
                                            onclick="togglePassword('konfirmasi', 'konfirmasiIcon')"
                                            class="absolute right-0 top-0 h-full px-4 text-stone-400 hover:text-stone-700 transition">
                    ...
                    <div class="border-t border-stone-100 bg-stone-50/60 px-6 md:px-7 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <button
                                type="submit"
                                name="submit"
                                onclick="return confirm('Yakin ingin menambahkan Admin baru? Akun ini akan dibuat dengan status Aktif dan dapat langsung digunakan untuk login.');"
                ...
                <aside class="space-y-4">
                    ...
                    <div class="bg-[#542f1b] text-white rounded-3xl p-5 shadow-lg shadow-stone-900/10 javanese-pattern">
                        ...
                        <p class="text-xs text-stone-300 leading-relaxed mt-3">
                            Admin dapat mengelola kabar melalui panel Webmaster, tetapi tidak dapat mengelola akun pengguna lain.
                        </p>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-3">
                                ...
                                <p class="text-xs text-stone-500 leading-relaxed">
                                    Pastikan nama Admin sudah benar.
                                </p>
                            ...
                            <div class="flex gap-3">
                                ...
                                <p class="text-xs text-stone-500 leading-relaxed">
                                    Gunakan username yang belum digunakan.
                                </p>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-amber-800/70 leading-relaxed mt-1">
                                    Admin baru langsung dibuat dengan status Aktif dan dapat login setelah akun berhasil dibuat.
                                </p>
